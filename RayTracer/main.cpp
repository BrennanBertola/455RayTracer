...
int main() {
    ...
    vector<vec3> tmp = {vec3(0, -.7, -.5), vec3(1, .4, -1), vec3(0,-.71,-1.5)};
    Triangle* triangle = new Triangle(tmp, .9, 1, .1, vec3(0,0,1), vec3(1,1,1), 4, 0);
    scene->addObj(triangle);

    tmp = {vec3(0,-.7,-.5), vec3(0,-.71,-1.5), vec3(-1.,.4, -1.0)};
...
//    scene->setLight(light);
//
//    sphere = new Sphere(vec3(.45, 0, -0.15), .15, .8, .1, .1, vec3(1,1,1), vec3(1,1,1), 4, 0);
//    scene->addObj(sphere);
//    sphere = new Sphere(vec3(0,0,-0.1), .2, .6, .3, .1, vec3(1,0,0), vec3(1,1,1), 32, 0);
//    scene->addObj(sphere);
//    sphere = new Sphere(vec3(-0.6,0,0), .3, .6, .2, .1, vec3(0,1,0), vec3(.5,1,.5), 64, 0);
//    scene->addObj(sphere);
//    sphere = new Sphere(vec3(0, -10000.5, 0), 10000, .9, 0, .1, vec3(0,0,1), vec3(1,1,1), 16, 0);
//    scene->addObj(sphere);
//
//    tracer.traceScene(image_width, image_height, scene);
//    delete scene;
